...
class JobIngestionService {
    constructor() {
        ...
        this.supabase = (0, supabase_1.createApiSupabaseClient)();
    }
    /**
     * Phase 1: Ingest ALL scraped jobs without any filtering
     */
    async ingestJobs(searchTerm, maxItems = 500) {
     ...
     */
    async getJobsForDeduplication(runId) {
...
exports.default = JobIngestionService;
